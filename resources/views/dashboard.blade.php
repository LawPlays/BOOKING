<x-app-layout>
    ...
    <div class="drawer">
        <div class="drawer-links">
            <a href="{{ url('/bookings/create') }}">CRIT BOKING</a>
            <a href="{{ url('/bookings') }}">VYU BOKINGS</a>
            <a href="{{ url('/profile') }}">HIRO MANAGEMENT</a>
        </div>
    </div>
